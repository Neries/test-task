    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="{{ Request::route()->getName() == 'home' ? 'active' : '' }}"><a href="{{ route('home') }}"><span class="glyphicon glyphicon-home"
                                                                                                                            aria-hidden="true"></span> Home</a></li>
                <li class="{{ Request::route()->getName() == 'employees' ? 'active' : '' }}"><a href="{{ route('employees') }}">
                        <span class="glyphicon  glyphicon-user" aria-hidden="true"></span> All</a></li>

                <li class="{{ Request::route()->getName() == 'createForm' ? 'active' : '' }}"><a href="{{ route('createForm') }}">
